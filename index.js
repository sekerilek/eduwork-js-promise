function jalan() {
  fetch(`https://newsapi.org/v2/top-headlines?country=id&apiKey=17ca9f86cf474fdf896cd28c8f6b269c`)
...
seachButton.addEventListener('click', function () {
  ...
  fetch(`https://newsapi.org/v2/everything?q=${inputKeyword.value}&apiKey=17ca9f86cf474fdf896cd28c8f6b269c`)
    .then(res => res.json())
    .then(res => {
